...
describe("transport:", () => {
  ...
  describe("disconnect:", () => {
    ...
    it("should cleanup resources", () => {
      ...
      return transport.disconnect().then(() => {
  ...
  describe("publish:", () => {
    ...
    it("should catch invalid correlationId params", () => {
      const transport = new Transport();
      return transport
        .publish("bob", {}, { correlationId: 44444 })
        .then(() => {
          throw new Error("Failed to catch invalid input.");
        })
        .catch((err) => {
  ...
  describe("request:", () => {
    ...
    it("should catch invalid correlationId params", () => {
      const transport = new Transport();
      return transport
        .request("bob", {}, { correlationId: 44444 })
        .then(() => {
          throw new Error("Failed to catch invalid input.");
        })
        .catch((err) => {
